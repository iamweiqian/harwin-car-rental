...
<div id="clockbox"></div>
	...
	<div align="center"><a href="utama_user.php">
	  <input name="Submit5" type="button" class="style19" value="UTAMA" />
	 <a href="senarai_penggunaan_user.php">
	<input name="Submit3" type="button" class="style19" value="SENARAI" />
	</a> <a href="tempahan.php">
	<input name="TEMPAHAN" type="button" class="style19" id="TEMPAHAN" value="TEMPAHAN" />
	<a href="status_tempah_user.php">
	<input name="Submit" type="button" class="style19" value="STATUS" />
	<a href="logout.php">
	<input name="Submit4" type="button" class="style19" value="KELUAR" />
