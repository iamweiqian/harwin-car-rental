...
//-->
	...
	<p align="right" >
      <form action="status_tempah_user.php" method="post" >
        <div align="center"><span class="style16 style17">[PLEASE ENTER YOUR IC/Passport NO. </span>
            ...
            <input type="submit" name="Submit10" value="Find" />
        </div>
        <label>
        <div align="center"><br />
            <br />
        ...
        <table width="984" border="1" align="center" cellpadding="3" cellspacing="0">
          <tr bgcolor="#FF6600">
            ...
            <th width="150" scope="row"><div align="left" class="style14">
                <div align="center">Name</div></div></th>
            <th width="200" scope="row"> IC/Passport No.</th>
            </div>
            <th width="200" scope="row"><div align="left" class="style14"><div align="center">Car</div></div></th>
            <th width="78" scope="row"><div align="left" class="style14"><div align="center">Start Date</div></div></th>
            <th width="78" scope="row">End Date</th>
            <th width="67" scope="row"><div align="left" class="style14"><div align="center">Start Time </div></div></th>
...
include "conn.php";
if($_POST){
$sql= "SELECT name,noic,car,start_date,end_date,start_hour,start_min,start_time,end_hour,end_min,end_time,status FROM booking WHERE noic='$_POST[noic]'";
...
?>
          <tr>
			...
			<td><a href="delete_tempahan_sendiri.php?noic=<?php echo $row['noic'];?>">Delete</a> </tr>
          <?php }
	}
	mysql_close($db_conn);
	?>
        ...
        <p>
          <label>
          <div align="center"><a href="status_tempah_user.php">
          <input type="button" name="Submit2" value="Refresh" />
</a>          </div>
          </label>
        </p>
      </form>
