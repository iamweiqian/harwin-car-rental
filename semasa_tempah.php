...
<div id="clockbox"></div>
	...
	<p align="right" >
      <p align="center" ><span class="style21">Car Booking Form</span>
      <form action="tempahan2.php" method="post" name="form2" target="_self" id="form2">
          <?php
include "conn.php";
$editbil = $_GET['bil'];
$sqlTampil = "SELECT name,noic,no_tel FROM user WHERE no= '$editbil'";
$qryTampil = mysql_query($sqlTampil, $db_conn)
or die ("Query Failed".mysql_error());
$dataTampil = mysql_fetch_array($qryTampil);
?>
        
        <table width="73%" border="4" align="center" cellpadding="5" cellspacing="0" bgcolor="#999999" summary="Car Rental Booking Form">
          
           
          <tr>
          <td bgcolor="#FF6600">Name</td>
          <td width="79%" bgcolor="#FFCC66"><?php print $dataTampil['name'];?>
		  <input name="name" type="hidden" value="<?php print $dataTampil['name'];?>" />
            </td>
        </tr>
          <tr>
          <td bgcolor="#FF6600">IC/Passport No.</td>
          <td width="79%" bgcolor="#FFCC66"><?php print $dataTampil['noic'];?>
		  <input name="noic" type="hidden" value="<?php print $dataTampil['noic'];?>" />
            </td>
        </tr>
           <tr>
          <td bgcolor="#FF6600">HP No.</td>
          <td width="79%" bgcolor="#FFCC66"><?php print $dataTampil['no_tel'];?>
		  <input name="notel" type="hidden" value="<?php print $dataTampil['no_tel'];?>" />
            </td>
        </tr>
