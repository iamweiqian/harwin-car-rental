...
<div id="clockbox"></div>
	...
	<p align="right" >
      ...
      <div align="center" class="style16 style17">
        <p>[Car Booking Status] </p>
        <p>&nbsp;</p>
      </div>
      <table width="974" border="1" align="center" cellpadding="3" cellspacing="0">
        <tr bgcolor="#FF6600">
          <th width="30" scope="row">No.</th>
          <th width="113" scope="row"><div align="left" class="style14">
              <div align="center">Name</div>
          </div></th>
        </tr>
        <?php 
include "conn.php";
$sql= "SELECT name,noic,car,start_date,end_date,start_hour,start_min,start_time,end_hour,end_min,end_time,status FROM booking";
...
?>
        <tr class="tulisan2">
          ...
          <td><form id="form2" name="form2" method="post" action="">
            <label>
              <input name="textfield" type="text" value="<?php echo $dataTampil['ans'];?>" />
              </label>
          </form>
          </td>
        </tr>
