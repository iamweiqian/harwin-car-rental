...
<div id="clockbox"></div>
	...
	<p align="right" >
      ...
      <p align="center" ><span class="style21">User List</span>      
      <p align="center" >      
      <table width="94%" border="4" align="center" cellpadding="4" cellspacing="4">
        <tr bgcolor="#FF6600">
          <td width="3%">No.</td>
          <td width="14%"><div align="center">IC/Passport No.</div></td>
          <td width="30%"><div align="center">Name</div></td>
          <td width="11%"><div align="center">HP No.</div></td>
          <td width="9%"><div align="center">Email</div></td>
          <td width="9%"><div align="center">User Name </div></td>
          <td width="8%"><div align="center">Password</div></td>
          <td width="9%"><div align="center">Action</div></td>
        </tr>
<?php
    ...
    while ($row=mysql_fetch_array($result)) {
        ...
        <tr>
          ...
          <td><a href="senarai_ahli_pengguna_admin_del.php?noic=<?php echo $row['noic'];?>">Delete</a></td>
        </tr>
    <?php }
?>
    ...
    <form id="form2" name="form2" method="post" action="">
        <a href="senarai_ahli_pengguna_admin.php"><input type="button" name="Submit2" value="Refresh" /></a>
        </label>
        </div>
      </label>
    </form>
